...
public class CheckAllFlightView  extends JFrame {
    ...
    public CheckAllFlightView(String title) {
    	 super(title);
    	 this.init();
    }
	...
	private void init() {
    	...
    	table.addMouseListener(new MouseAdapter() {
    		...
    		public void mouseClicked(MouseEvent e) {
				...
				//	CheckAllFlightView.this.flightNo.setText(model.getValueAt(row, 0).toString());
				}
		...
		choose.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (orderList.size() == 0) {
					JOptionPane.showMessageDialog(CheckAllFlightView.this, "您未选择航班！",
							"提示信息", JOptionPane.ERROR_MESSAGE);
				}else {
					CheckAllFlightView.this.setVisible(false);
					CheckAllFlightView.this.dispose();
					frame.setEnabled(true);
					frame.requestFocus();
					// 设置父窗口航班号文本框value为选中航班号
					CheckAllFlightView.this.flightNo.setText(orderList.get(0));
				}*/
				CheckAllFlightView.this.setVisible(false);
				CheckAllFlightView.this.dispose();
			}
    ...
    public void windowClosing(WindowEvent windowEvent) {
        ...
        if(modal) {
        	frame.setEnabled(true);
        	this.flightNo.setText(CheckAllFlightView.this.flightNo.getText());
        }
    }   
	...
	private Vector getTableData() {
		...
		List<Flight> flights =dataOperateUtil.readFlightData(Constants.FILE_FLIGHTS_NAME);
